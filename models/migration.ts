...
type MigrationSnakeCase = Record<string, Migration[keyof Migration]>
...
export async function getMigratons(db: SQLiteDatabase): Promise<Migration[]> {
  const rows = await db.getAllAsync<MigrationSnakeCase>(
